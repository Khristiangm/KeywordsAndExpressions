...
public class Main {
	...
	//WRONG EXAMPLE
    // int int = 5; Nao e possivel dar nome de variavel de keywords reservadas do sistema.
    //CORRECT EXAMPLE
         int       myNum =   5;                          //Quando nao sao utilizadas chaves reservadas do sistema para dar nome as variaveis o sistema flui normalmente..
    // DataType/Expression/Value              //When they are not used as reserved system keys, the program normally flows.
    }

}
//The Java programming language has 50 keywords.
// Each keyword has a specific meaning in the language.
// You can’t use a keyword for anything other than its pre-assigned meaning.
